...
async function insertSales(saleid, salesperson, customer, Product, Quantity) {
    let connection;
    ...
    try {
        ...
        oracledb.autoCommit = true;
        await connection.execute(
            `INSERT INTO sale (sale_id,  salesperson, customer, Product, Quantity) values (:s, :sp, :c, :P, :Q)`, [saleid, salesperson, customer, Product, Quantity]
        );
        resolve(result.rows);
...
module.exports = { Sales_record, getSP, work, insertSales };